...
class ITM_V11_Format (Format):
    header_desc = (
            ...
            { 'key': 'flags',
              'type': 'DWORD',
              'off': 0x0018,
              'mask': { 0x0001: 'Critical/Unsellable', 0x0002: 'TwoHanded', 0x0004: 'Movable', 0x0008: 'Displayable', 0x0010: 'Cursed', 0x0020: 'Unknown bit5', 0x0040: 'Magical', 0x0080: 'Bow', 0x0100: 'Silver', 0x0200: 'ColdIron', 0x0400: 'Stolen/Unsellable', 0x0800: 'Conversable', 0x1000: 'Pulsating' },
              'label': 'Flags'},
            ...
            { 'key': 'usability_mask',
              ...
              'label': 'Usability mask/Unusable by'},
