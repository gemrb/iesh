...
# Conforms to IESDP 4.5.2009

from infinity.format import Format, register_format


class STOR_V90_Format (Format):
    ...
    header_desc = (
            ...
            { 'key': 'type',
                'type': 'DWORD',
                'off': 0x0008,
                'enum': { 0: 'Store', 1: 'Tavern', 2: 'Inn', 3: 'Temple', 4: 'Container' },
                'label': 'Type' },
    ...
    bought_item_desc = (
            { 'key': 'type',
                'type': 'DWORD',
                'off': 0x0000,
                'enum': 'itemtypes',  # FIXME: Really? Probably the list should be specified
                'label': 'Type' },
    )
    ...
    sold_item_desc = (
            ...
            { 'key': 'flags',
                'type': 'DWORD',
                'off': 0x0010,
                'mask': { 0x01: 'Identified', 0x02: 'Unstealable', 0x04: 'Stolen', 0x08: 'IWD1 Undroppable/IWD2 Has lore requirement' },
                'label': 'Flags' },
